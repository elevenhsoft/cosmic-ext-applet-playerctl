...
_install_icon:
    install -Dm0644 'data/icons/scalable/apps/io.github.elevenhsoft.CosmicExtAppletPlayerctl-symbolic.svg' {{iconsdir}}/io.github.elevenhsoft.CosmicExtAppletPlayerctl-symbolic.svg
...
install:(_install_applet 'io.github.elevenhsoft.CosmicExtAppletPlayerctl' 'cosmic-ext-applet-playerctl') 
